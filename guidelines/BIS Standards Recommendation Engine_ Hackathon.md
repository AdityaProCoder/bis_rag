...
* Open to students, professionals, and freelancers.  
* This is an **online event**. Participants must attend remotely for the full duration.

### **2.2 Rules of Engagement**

* **Autonomy**: You can use open-source libraries, frameworks, and pre-trained models.  
* **Originality**: Work must be started and completed during the event window. Reusing full projects from previous events is prohibited.  
* **Disqualification:** A team will be disqualified if they: (a) submit work that was not started during the event window, (b) plagiarise code or content from other teams, (c) fail to submit by the deadline. Organizer decisions are final.
...
[Download the Dataset, Public Test Set and Output JSON schema from here](https://drive.google.com/drive/folders/1uEYeChFHBZX9zN3xlE_PD_GN39JKWIGi?usp=sharing).

## **7\. TIMELINE**

* **Hour 0**: Kickoff, Dataset access, **Public Test Set**, and **eval\_script.py** release.  
* **Final Submission Deadline: 3rd May, 11:59pm IST.**
...
For technical issues or clarifications during the event, kindly communicate through the following Whatsapp Group: [BIS X SS Hackathon](https://chat.whatsapp.com/FBDWeSmUFPMFB9OmPd0uh2)

**Good luck\! Let's build something that helps small businesses navigate compliance with ease.**
